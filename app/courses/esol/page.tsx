...
export default function ESOLPage() {
  const allCourses = courses as Course[];
  const esolCourses = allCourses.filter((course) => course.category === "ESOL");
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-semibold text-[var(--color-brand-primary)] md:text-4xl">
              ESOL tuition for confident English in the UK
            </h1>
            <p className="mt-4 text-base leading-7 text-[#425161]">
              Live ESOL classes focused on real-life communication, exam
              readiness, and steady progress across CEFR levels.
            </p>
