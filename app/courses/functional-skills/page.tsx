...
export default function FunctionalSkillsPage() {
  ...
  const functionalCourses = allCourses.filter(
    (course) => course.category === "Functional Skills"
  );
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-semibold text-[var(--color-brand-primary)] md:text-4xl">
              Practical, work-ready Functional Skills tuition
            </h1>
            <p className="mt-4 text-base leading-7 text-[#425161]">
              Functional Skills Maths and English (Level 1 &amp; 2) designed for
              learners who want recognised qualifications for work, study, or
              apprenticeships.
            </p>
